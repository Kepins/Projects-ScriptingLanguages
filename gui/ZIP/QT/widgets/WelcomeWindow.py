...
from widgets.UnlockedWindow import UnlockedWindow
...
class WelcomeWindow(QMainWindow):
    ...
    def on_create_pass_db_pressed(self):
        ...
        if create_pass_db_dialog.auto_saving_manager:
            self.new_window = UnlockedWindow(welcome_screen=self, auto_saving_manager=create_pass_db_dialog.auto_saving_manager)
    ...
    def on_open_pass_db_pressed(self):
        ...
        if open_pass_db_dialog.auto_saving_manager:
            self.new_window = UnlockedWindow(welcome_screen=self, auto_saving_manager=open_pass_db_dialog.auto_saving_manager)
            self.new_window.show()
